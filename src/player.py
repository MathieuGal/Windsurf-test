...
from config import INITIAL_PLAYER_HEALTH, INITIAL_PLAYER_MUN, MAX_PLAYER_HEALTH, \
    MAX_PLAYER_MUN, FIRE_RATE, SPRITES, TIR_GAUCHE, TIR_DROIT, TIR_HAUT, TIR_BAS, \
        DEPLACEMENT_BAS, DEPLACEMENT_HAUT, DEPLACEMENT_GAUCHE, DEPLACEMENT_DROIT, INITIAL_PLAYER_SPEED
